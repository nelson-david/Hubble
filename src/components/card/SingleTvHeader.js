                    ...
                    <div className="singlemovie__info">
                        ...
                        <div className="facts">
                            ...
                            <span className="release">
                                Last Aired: {formatDate(movie.last_air_date)} ({movie.production_countries[0].iso_3166_1})
                            </span>
                            <BsCircleFill />
                        ...
                        <div className="facts">
                            <span className="release white-grey">
                                Currently On: Season  {movie.number_of_seasons}
                            </span>
                            <BsCircleFill />
                            <span className="runtime white-grey">
